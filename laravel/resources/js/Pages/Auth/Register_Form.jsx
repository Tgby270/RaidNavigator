...
export default function RegisterForm({ clubs = [], onSwitchToLogin }) {
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={submit}>
                ...
                <div className="mb-4">
                    ...
                    />
                    {errors.family_name && (
                        <div className="mt-2 text-sm text-red-600">{errors.family_name}</div>
                    )}
                </div>
                ...
                <div className="mb-2">
                    ...
                    />
                    {errors.adresse && (
                        <div className="mt-2 text-sm text-red-600">{errors.adresse}</div>
                    )}
                </div>
                ...
                <div className="mb-4">
                    ...
                    />
                    {errors.postal_code && (
                        <div className="mt-2 text-sm text-red-600">{errors.postal_code}</div>
                    )}
                </div>
                ...
                <div className="mb-4">
                    ...
                    />
                    {errors.city && (
                        <div className="mt-2 text-sm text-red-600">{errors.city}</div>
                    )}
                </div>
                ...
                <div className="mb-4">
                    ...
                    />
                    {errors.phone_number && (
                        <div className="mt-2 text-sm text-red-600">{errors.phone_number}</div>
                    )}
                </div>
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 text-gray-700 rounded-lg focus:ring-2 focus:ring-gray-800 focus:border-transparent outline-none"
                        onChange={(e) => setData('date_naissance', e.target.value)}
                    />
                    {errors.date_naissance && (
                        <div className="mt-2 text-sm text-red-600">{errors.date_naissance}</div>
                    )}
                </div>
