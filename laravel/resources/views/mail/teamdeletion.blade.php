    ...
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <p class="info-text">
                    Le manager <strong>{{ $data['managerName'] }}</strong> a supprimé l'équipe. Vous n'êtes plus inscrit pour cette course.
                </p>
            </div>
            ...
            <p style="color: #6b7280; font-size: 14px; margin-top: 30px; text-align: center;">
                Vous pouvez rejoindre une autre équipe ou en créer une nouvelle pour participer à cette course.
            </p>
        </div>
